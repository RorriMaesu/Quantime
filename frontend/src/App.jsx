  ...
  const startVoiceChat = async () => {
    try {
      ...
      processor.onaudioprocess = (e) => {
        ...
        // Do not stream mic data to the server if the assistant is speaking or thinking
        if (ws.readyState === WebSocket.OPEN && !isPlayingRef.current && voiceStatus !== "thinking" && voiceStatus !== "speaking") {
          ...
          <div className="relative w-full max-w-lg bg-gray-900 border border-gray-800 rounded-3xl p-6 md:p-8 shadow-2xl z-10 flex flex-col space-y-6">
            ...
            <div className="flex flex-col items-center justify-center py-6">
              ...
              <span className="text-xs text-gray-505 mt-3 font-semibold font-mono">
                {voiceStatus === 'recording' ? 'Speak now... (Silence ends turn)' : voiceStatus === 'thinking' ? 'Gemma 4 is thinking...' : 'Assistant is speaking (Tap mic to interrupt)...'}
              </span>
            </div>
